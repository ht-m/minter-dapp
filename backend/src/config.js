...
const namePrefix = "FULLNAMECOLLECTION";
const description = "LONG DESCRIPTION WILL ADDED HERE";
...
const extraMetadata = {
  external_url: "https://website.com", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'FULLNAMECOLLECTION';
const CONTRACT_SYMBOL = 'FNC';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x7cC293bc17430afDC6ff35138ebfA6790dc8B049';
const TREASURY_ADDRESS = '0x7cC293bc17430afDC6ff35138ebfA6790dc8B049';
...
const ROYALTY_ADDRESS = "0x7cC293bc17430afDC6ff35138ebfA6790dc8B049"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = [
    "0xBe586A24312C33aDD51b2C323B8268e939C3eb93",
    "0x7cC293bc17430afDC6ff35138ebfA6790dc8B049",
